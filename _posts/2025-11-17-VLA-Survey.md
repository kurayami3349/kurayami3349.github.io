---
title: VLA-Survey
date: 2025-11-17 +/-0800
categories: [论文笔记]
tags: [VLA-Survey]     # TAG names should always be lowercase
author: sss01
description: overview of VLA-Survey
---
...
| Model         | Description   | significant novel features   | project website    |
| ------------- | ---------------- | ---------------- |------------------- |
| example model | overview of example model:[conference] [year] | key novel features of example model | [example model](https://github.com/username/example-model) |
| CLIPort       | overview of CLIPort:CoRL 2021                 | key novel features of CLIPort       | [CLIPort](https://cliport.github.io/)                      |
| RT-1          | overview of RT-1:CoRL 2023                    | key novel features of RT-1          | [RT-1](https://robotics-transformer1.github.io/)           |
| RT-2          | overview of RT-2:[conference] [year]          | key novel features of RT-2          | [RT-2](https://robotics-transformer2.github.io/)           |
...
| EcoT          | overview of EcoT:[conference] [year]          | key novel features of EcoT          | [EcoT](https://embodied-cot.github.io/)                    |
